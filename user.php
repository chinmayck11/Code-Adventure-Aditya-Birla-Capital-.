                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="insta_id" placeholder="Insta id" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <input type="text" class="form-control" name="Address" placeholder="Home_Address" >
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="postalcode" placeholder="postal_code">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" rows="4" cols="80" class="form-control" name="Aadharnum" placeholder="Aadhar Number" ></textarea>
                                                </div>
                                            </div>
                                        </div>
