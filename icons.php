                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Our Trending Products (Redeem your points for discount on these products) </h4>
                                    <a class="hint" type="button"> Redeem </a>
                                </div>
